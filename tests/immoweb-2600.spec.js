...
test('immo test', async ({ page }) => {
  await page.goto(
    `https://www.immoweb.be/nl/zoeken/huis/te-koop/berchem/2600?countries=BE&minPrice=${MIN_PRICE}&maxPrice=${MAX_PRICE}&minSurface=${MIN_SURFACE}&page=1&orderBy=newest`,
  );
