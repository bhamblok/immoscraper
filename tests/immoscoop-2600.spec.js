...
const url = `https://www.immoscoop.be/zoeken/te-koop/2600-berchem/all/woonhuis?minPrice=${MIN_PRICE}&maxPrice=${MAX_PRICE}&sort=date%2CDESC`;
const title = 'Immoscoop | 2600 Berchem';
