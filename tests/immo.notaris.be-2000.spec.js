...
// https://immo.notaris.be/nl/vastgoed-te-koop/2000-antwerpen-belgie?area=2000+Antwerpen%2C+Belgi%C3%AB&geocoding=51.2198771_4.4011356&latitude=51.2198771&longitude=4.4011356&gender=SALE&type=HOUSE&max_price=750000&radius=5

test('immo test', async ({ page }) => {
  const newImmo = await scrape({
    page,
    url: `https://immo.notaris.be/nl/vastgoed-te-koop/2000-antwerpen-belgie?area=2000+Antwerpen%2C+Belgi%C3%AB&geocoding=51.2198771_4.4011356&latitude=51.2198771&longitude=4.4011356&gender=SALE&type=HOUSE&max_price=${MAX_PRICE}&radius=5`,
    title: 'immo.notaris.be | 2000 Antwerpen',
