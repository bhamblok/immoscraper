...
// https://www.deboerenpartners.be/te-koop/huis/2018%7Cantwerpen/alle-prijzen?term=&status=te+koop&bedrooms=&view=list&sort=null

test('immo test', async ({ page }) => {
  const newImmo = await scrape({
    page,
    url: 'https://www.deboerenpartners.be/te-koop/huis/2018%7Cantwerpen/alle-prijzen?term=&status=te+koop&bedrooms=&view=list&sort=null',
    title: 'De Boer en Partners | 2018 Antwerpen',
