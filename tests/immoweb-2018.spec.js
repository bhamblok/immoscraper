...
// https://www.immoweb.be/nl/zoeken/huis/te-koop/Antwerpen/2018?countries=BE&maxPrice=750000&minPrice=350000&minSurface=170&page=1&orderBy=newest
...
test('immo test', async ({ page }) => {
  await page.goto(
    `https://www.immoweb.be/nl/zoeken/huis/te-koop/Antwerpen/2018?countries=BE&minPrice=${MIN_PRICE}&maxPrice=${MAX_PRICE}&minSurface=${MIN_SURFACE}&page=1&orderBy=newest`,
  );
