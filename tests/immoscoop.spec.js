...
const url = `https://www.immoscoop.be/zoeken/te-koop/2000-antwerpen,2018-antwerpen,2600-berchem/alle/woonhuis?minPrice=${MIN_PRICE}&maxPrice=${MAX_PRICE}&sort=date%2CDESC`;
