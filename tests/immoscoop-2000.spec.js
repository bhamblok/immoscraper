...
// https://www.immoscoop.be/zoeken/te-koop/2000-antwerpen/all/woonhuis?minPrice=400000&maxPrice=750000&sort=date%2CDESC

test('immo test', async ({ page }) => {
  const newImmo = await scrape({
    page,
    url: `https://www.immoscoop.be/zoeken/te-koop/2000-antwerpen/all/woonhuis?minPrice=${MIN_PRICE}&maxPrice=${MAX_PRICE}&sort=date%2CDESC`,
    title: 'Immoscoop | 2000 Antwerpen',
