...
const url = `https://www.immoscoop.be/zoeken/te-koop/2000-antwerpen/all/woonhuis?minPrice=${MIN_PRICE}&maxPrice=${MAX_PRICE}&sort=date%2CDESC`;
const title = 'Immoscoop | 2000 Antwerpen';
